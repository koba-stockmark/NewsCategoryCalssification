...
背景
    ...
    column_dic = [
        ...
        "ステップ", "開く", "手法", "主役", "脇役", "スペック", "応える", "答える", "社長", "会長"
    ]
    modality_column_dic = [
        "<疑問>", "<限定>", "<容易>", "<意思・願望>"
    ]
    ...
    kaihatsu_dic = [
        ...
        "リサイクル", "測量", "測定", "測位", "観測", "観察", "計測", "反応", "統合", "結合", "融合",
        "用いる", "減らす", "増やす", "改良", "改善", "補正", "改修", "駆使", "検証",
        "特性", "軽量", "高速",
    ...
    o_v_kenkyuu4_dic = {"obj": {"研究", "究明", "解明", "解析", "方法", "検証"},
                        "verb": {"道", "光", "望み", "希望"}
                        }
    ...
    # サービス開始
    service_dic = [
        "サービス開始", "稼働", "参入", "導入確定", "提供", "追加", "復活", "着手", "運用", "[リリース]", "誕生", "開設", "出版"
    ]
    # O-V 規則
    ...
    o_v_seisan2_dic = {"verb": {"生産", "量産", "製造", "運転", "運用"},
                       "modality": {"<目標>"}
                       }
    ...
    phrase_rule = [
        ...
        {"label": "<生産活動>", "rule": o_v_seisan2_dic},
